...
return [
    ...
    | predeterminados usados por la clase validadora.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se usan para intercambiar marcadores de
    | atributos con algo más legible, como "Dirección de correo electrónico"
    | en lugar de "email". Esto simplemente nos ayuda a hacer los mensajes
    | más expresivos.
    |
    */
